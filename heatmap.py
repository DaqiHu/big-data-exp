...
# 读取CSV文件的路径
file_path = [r'data//PRSA_Data_Aotizhongxin_20130301-20170228.csv',
...
position = ['Aotizhongxin', 'Changping', 'Dingling', 'Dongsi', 'Guanyuan', 'Gucheng', 'Huairou', 'Nongzhanguan',
...
# 确保所有数值列的类型为浮点数或整数
cols_to_convert = ['PM2.5', 'PM10', 'SO2', 'NO2', 'CO', 'O3', 'TEMP', 'PRES', 'DEWP',  'WSPM']
